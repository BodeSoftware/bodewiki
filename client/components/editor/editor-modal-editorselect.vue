          ...
          v-layout(row, wrap, justify-center)
            ...
            v-flex(xs4)
              v-card.radius-7.animated.fadeInUp.wait-p5s(
                ...
                v-card-text.text-center(@click='selectEditor("bode")')
                  img(src='/_assets/svg/icon-cube.svg', alt='Bode Editor', style='width: 36px;')
                  .body-2.primary--text.mt-2 Bode
                  .caption.teal--text Advanced Editor
            v-flex(xs12)
